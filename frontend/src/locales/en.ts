export default {
  ...
  'Friday': 'Fri',
  'Saturday': 'Sat',
  'Manus Computer': 'Dzeck Computer',
  'Manus is using': 'Dzeck is using',
  'Jump to live': 'Jump to live',
  'Failed to load file content': 'Failed to load file content',
  'Give Manus a task to work on...': 'Give Dzeck a task to work on...',
  // Shell tools
  ...
  'This will permanently delete all chat sessions. This action cannot be undone.': 'This will permanently delete all chat sessions. This action cannot be undone.',
  ...
  'Archive': 'Archive',
  // Login/Register Page
  'Login to Manus': 'Login to Dzeck',
  'Register to Manus': 'Register to Dzeck',
  'Full Name': 'Full Name',
  'Email': 'Email',
  'Password': 'Password',
  ...
  'Registration successful! Welcome to Manus': 'Registration successful! Welcome to Dzeck',
