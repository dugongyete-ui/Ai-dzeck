export default {
  ...
  'Friday': '周五',
  'Saturday': '周六',
  'Manus Computer': 'Dzeck 的电脑',
  'Manus is using': 'Dzeck 正在使用',
  'Jump to live': '跳到实时',
  'Failed to load file content': '加载文件内容失败',
  'Give Manus a task to work on...': '给 Dzeck 一个任务...',
  // Shell tools
  ...
  'This will permanently delete all chat sessions. This action cannot be undone.': '这将永久删除所有聊天会话，此操作无法撤消。',
  'Delete All': '全部删除',
  ...
  'Archive': '压缩包',
  // Login/Register Page
  'Login to Manus': '登录 Dzeck',
  'Register to Manus': '注册 Dzeck',
  'Full Name': '姓名',
  'Email': '邮箱',
  'Password': '密码',
  ...
  'Registration successful! Welcome to Manus': '注册成功！欢迎使用 Dzeck',
